...
4. [Realizando a carga dos dados](#carregandoosdados)

5. [Visão Inicial dos Dados](#visaodosdados)

6. [Analisando os tipos das variáveis nas bases](#analisandobases)
...
7. [Normatizando o nome e escolhendo as variáveis](#normalizandovariaveis)

8. [Tratamento e padronizando as Datas](#tratandodatas)

9. [Gerando dados calculados](#calculodedados)

10. [Merge das bases de dados](#merge)

11. [Análise de frequências de variáveis qualitativas](#analisefreqvarquali)
...
13. [Realizando o teste de Hipíotese](#testedehipotese)
	+ [Hipótese](#hipotese)
	+ [Teste de Shapiro Wilk](#testeShapiroWilk)
		...
		+ [Durante a Política de Preço](#durantepoliticapreco)
			...
			+ [Segundo ano da análise - 01/03/2021](#segundoanoanalise)
			...
			+ [Terceiro ano da análise - 01/03/2022](#terceiroanoanalise)
			...
			+ [Quarto ano da análise - 01/03/2023](#quartoanoanalise)
...
14. [Manipulando base de dados com dados faltantes e outliers](#manipulandomissingeout)
...
15. [Tela do Sistema - Shiny](#telaShiny)
...
sample_combustiveis_agg <- 
   dplyr::bind_rows(base::merge(sample_combustiveis_agg %>%
...
filter_uf = "RJ"
filter_produto = c("GASOLINA","DIESEL","DIESEL S10")
graph_file <- paste("Heatmat do Valor de Venda dos combustíveis no Estado",
                    filter_uf, sep = " ")
extensao_file <- "jpg"
...
graph_file <- paste("Histograma da distribuição do Valor de Venda no Brasil do produto", 
                    filter_produto, sep = " ")
extensao_file <- "jpg"
...
graph_file <- paste("Histograma da distribuição do Valor de Venda do produto",
                    filter_uf,"do produto",filter_produto, sep = " ")
extensao_file <- "jpg"
...
graph_file <- paste("Histrograma da evolução temporal no Brasil do produto", 
                    filter_produto, sep = " ")
extensao_file <- "jpg"
...
graph_file <- paste("Evolução temporal no Estado do",
                    filter_uf, 
                    "do produto",filter_produto, sep = " ")
extensao_file <- "jpg"
...
# Tela do Sistema - Shiny{#telaShiny}

![Tela do App](Images/TelaShinyInto.jpeg)

![Tela do App](Images/TelaShiny.jpeg)    


# Github{#github}

Todo o conteúdo da análise aqui proposta encontra-se no [**GitHub**.](https://github.com/EraNFPJr/ExploratoryDataAnalysis/tree/main)

Segue abaixo tela do Github.

![Tela do GitHub](Images/Github.jpeg)
