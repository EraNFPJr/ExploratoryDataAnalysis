...
graph_file <- paste("Histograma da distribuição do Valor de Venda no Brasil do produto", produto_filtro, sep = " ")
extensao_file <- "jpg"
...
combustiveis_glp %>% dlookr::diagnose()

combustiveis_glp %>% naniar::miss_var_summary()

combustiveis_glp %>% gg_miss_var()

combustiveis_glp %>% gg_miss_upset()
